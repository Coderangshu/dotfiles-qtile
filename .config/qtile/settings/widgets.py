...
primary_widgets = [
    ...
    *workspaces(),
    ...
    colour_have_updates=colors['color5'],colour_no_updates=colors['color5'],no_update_string='No updates', execute="echo -e '1998' | sudo -S sudo powerpill --noconfirm -Su && paru --noconfirm -Su && notify-send 'System Updated'"),
