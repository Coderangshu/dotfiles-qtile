...
primary_widgets = [
    ...
    *workspaces(),
    ...
    # icon(bg='color4',fg='dark',fontsize=30,text=" ",padding=0),

    widget.TaskList(**base(),highlight_method='block',border=colors['focus'],margin_y=0,parse_text=tasklistStringHide,icon_size=17,txt_floating='',fontsize=20),
    ...
    colour_have_updates=colors['color4'],colour_no_updates=colors['color4'],no_update_string='No updates', execute="echo -e '1998' | sudo -S sudo powerpill --noconfirm -Su && paru --noconfirm -Su && notify-send 'System Updated'"),
    ...
    # Battery
    # widget.Battery(**base(),charge_char=' ',discharge_char=' ',full_char=' ',empty_char=' ', 
